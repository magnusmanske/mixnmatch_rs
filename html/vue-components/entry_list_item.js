				...
				<div class='entry_cell_left col-sm-12 col-md-2' style='display: flex;'>
					...
					<div style="display: inline-block; position: relative;">
						...
						<span v-if='show_catalog && typeof get_catalog(entry.catalog)!="undefined"'><router-link
								:to='"/catalog/"+entry.catalog'><small>{{get_catalog(entry.catalog).name}}</small></router-link>:</span>
						<br v-if='twoline' />
						<span v-if='show_permalink && show_checkbox && !radio_name' class="permalink-hover-inline d-none d-md-inline-block"><router-link
								:to='"/entry/"+entry.id' class='text-muted' style='font-size:0.8em'>#</router-link></span><entry-link :entry='entry'></entry-link><span v-if='show_permalink && radio_name' class="permalink-hover-after d-none d-md-inline"><router-link
								:to='"/entry/"+entry.id' class='text-muted' style='font-size:0.8em;margin-left:0.25em'>#</router-link></span>
