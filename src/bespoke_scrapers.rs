...
impl BespokeScraper7696 {
    ...
    fn extract_species_urls(sitemap_text: &str) -> Vec<String> {
        lazy_static! {
    ...
    fn parse_species_url(url: &str) -> Option<(String, String)> {
        lazy_static! {
    ...
    fn slug_to_scientific_name(slug: &str) -> String {
    ...
    fn section_to_description(section: &str) -> &'static str {
        Self::SECTIONS
            .iter()
            .find(|(s, _)| *s == section)
            .map(|(_, d)| *d)
...
impl BespokeScraper7697 {
    fn binding_to_entry(catalog_id: usize, binding: &serde_json::Value) -> Option<ExtendedEntry> {
    ...
    fn featherbase_id_to_name(id: &str) -> Option<String> {
    ...
    fn featherbase_id_to_description(id: &str) -> &'static str {
    ...
    #[allow(dead_code)]
    fn parse_common_name(html: &str) -> Option<String> {
        lazy_static! {
    ...
    #[allow(dead_code)]
    fn parse_family_from_html(html: &str) -> Option<String> {
        lazy_static! {
...
mod tests {
    ...
    // ---- BespokeScraper7697 (featherbase.info) tests ----
